...
Resource.RcvBuffer(3).datatype = 'int16';
Resource.RcvBuffer(3).rowsPerFrame = SA.rowsPerFrame; 
Resource.RcvBuffer(3).colsPerFrame = Resource.Parameters.numRcvChannels;
Resource.RcvBuffer(3).numFrames = saSaveFrames;
...
numRcvDef = ...
    ...
    + SA.nRay*Resource.RcvBuffer(3).numFrames;          % frames for SA acquisition
